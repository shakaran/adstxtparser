    ...
    public function readExternalFile(string $domain = 'localhost')
    {
        ...
        else
        {
            ...
            */
            ...
            $lines = explode(PHP_EOL, $adsTxtFile);
                ...
                foreach($lines as $lineNumber => $value)
                {
                    ...
                    else
                    {
                        ...
                        if (FALSE !==  strpos($value, '#') )
                        {
                            ...
                            $remain = trim(array_slice($parts, 1, $numberParts - 1));
                        ...
                        if (FALSE !==  strpos($value, ',') )
                        {
                            ...
                            $relationship = trim(strtolower($fields[2]));
                            ...
                            $this->fields[] = [
                                ...
                                'fiedls' => [
                                    ...
                                    'domain' => urlencode(trim($fields[0])),
                                    /**
                                    ...
                                    'publisher_account_id' => urlencode(trim($fields[1])),
                                    /**
                                    ...
                                    'certification_authority_id' => urlencode(trim($fields[3])),
                                    /*
